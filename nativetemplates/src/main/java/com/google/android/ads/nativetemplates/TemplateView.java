...
public class TemplateView extends FrameLayout {
  ...
  public void setNativeAd(UnifiedNativeAd nativeAd) {
    ...
    //  Set the secondary view to be the btn_rate_us rating if available.
  ...
  private void initView(Context context, AttributeSet attributeSet) {
    if (templateType == R.layout.gnt_medium_template_view || templateType == R.layout.gnt_small_template_view) {
      return;
    }
  ...
  public void setTemplateView(int mTemplateType) {
    if(mTemplateType==0/*TYPE_SMALL_TEMPLATE_1*/){
      templateType = R.layout.gnt_small_template_view_1;
    }else if(mTemplateType==222/*TYPE_SMALL_TEMPLATE_2*/){
      templateType = R.layout.gnt_small_template_view_2;
    }else if(mTemplateType==1/*TYPE_SMALL_TEMPLATE_3*/){
      templateType = R.layout.gnt_small_template_view_3;
    }else if(mTemplateType==111/*TYPE_MEDIUM_TEMPLATE*/){
      templateType = R.layout.gnt_medium_template_view;
    }else if(mTemplateType == 2){
      templateType = R.layout.gnt_native_advanced_template;
    } else{
      templateType = R.layout.gnt_small_template_view_1;
    }
